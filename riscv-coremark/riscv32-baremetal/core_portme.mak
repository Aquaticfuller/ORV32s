...
PORT_CFLAGS = -O2 -mcmodel=medany -static -std=gnu99 -fno-common -nostdlib -nostartfiles -lm -lgcc -T $(PORT_DIR)/link.ld
#PORT_CFLAGS = -O2 -mcmodel=medany -static -std=gnu99 -ffast-math -fno-common -fno-builtin-printf -nostdlib -nostdlib -nostartfiles -lm -lgcc -T $(PORT_DIR)/link.ld
