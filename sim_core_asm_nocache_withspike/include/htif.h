...
#include <vector>
//host interface
class htif_t : public chunked_memif_t  // chunked_memif_t:  fesvr/chunked_memif_t
{
 public:
  htif_t();
 ...
 private:
  ...
  device_list_t device_list;  //  device_list_t:  /fesvr/device.h
